...
useHead({
  ...
  link: [
    { rel: 'canonical', href: 'https://fasionable.dexignzone.com/xhtml/account-return-request.html' },
            ...
            <div class="dz-bnr-inr-entry">
              <nav aria-label="breadcrumb" class="breadcrumb-row">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Account Return Request</li>
                </ul>
              </nav>
            </div>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 m-b30">
                    <div class="order-cancel-card">
                      <div class="order-head">
                        ...
                        <a href="javascript:void(0);" class="btn-link text-underline text-success">Return Made</a>
                      </div>
                  ...
                  <div class="col-lg-6 m-b30">
                    <div class="order-cancel-card">
                      <div class="order-head">
                        <h6 class="mb-0">Request No: <span class="text-primary">#1374837</span></h6>
                        <a href="javascript:void(0);" class="btn-link text-underline text-priamry">Request Submited</a>
                      </div>
                      <a href="/account-return-request-detail" class="order-cancel-box">
                        <div class="cancel-media">
