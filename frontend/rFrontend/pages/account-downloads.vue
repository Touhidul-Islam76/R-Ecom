...
useHead({
  ...
  link: [
    { rel: 'canonical', href: 'https://fasionable.dexignzone.com/xhtml/account-downloads.html' },
            ...
            <div class="dz-bnr-inr-entry">
              <nav aria-label="breadcrumb" class="breadcrumb-row">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Account Downloads</li>
                </ul>
              </nav>
            </div>
          </div>
                    ...
                    <table class="table check-tbl">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="product-item-img"><img src="/images/shop/small/pic1.png" alt="/" /></td>
                          <td class="product-item-name">Collar Casual Shirt</td>
                          <td><a href="/product-default" class="btn btn-md btn-outline-secondary btnhover20">Download</a></td>
                        </tr>
                        <tr>
                          <td class="product-item-price">2</td>
                          <td class="product-item-img"><img src="/images/shop/small/pic2.png" alt="/" /></td>
                          <td class="product-item-name">Collar Tranding Shirt</td>
                          <td><a href="/product-default" class="btn btn-md btn-outline-secondary btnhover20">Download</a></td>
                        </tr>
                        <tr>
                          <td class="product-item-price">3</td>
                          <td class="product-item-img"><img src="/images/shop/small/pic1.png" alt="/" /></td>
                          <td class="product-item-name">Casual Full Shirt</td>
                          <td><a href="/product-default" class="btn btn-md btn-outline-secondary btnhover20">Download</a></td>
                        </tr>
                        <tr>
                          <td class="product-item-price">4</td>
                          <td class="product-item-img"><img src="/images/shop/small/pic2.png" alt="/" /></td>
                          <td class="product-item-name">Tranding Full Shirt</td>
                          <td><a href="/product-default" class="btn btn-md btn-outline-secondary btnhover20">Download</a></td>
                        </tr>
                      </tbody>
                    </table>
