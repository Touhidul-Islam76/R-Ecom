          ...
          <div class="login-area">
            ...
            <form class="row gx-2">
              <div class="col-xl-6 col-md-12 mb-3 mb-xl-0">
                <button name="submit" value="submit" type="submit" class="btn google-btn w-100">
                  <svg width="22" height="22" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                      <clipPath id="clip0_1381_2836"><rect width="26" height="26" fill="white"/></clipPath>
                    </defs>
                ...
                <button name="submit" value="submit" type="submit" class="btn google-btn w-100">
                  <svg height="22" viewBox="0 0 176 176" width="22" xmlns="http://www.w3.org/2000/svg">
                    <g id="Layer_2"><g id="_01.facebook">
                      ...
                      <path d="m115.88 77.58-1.77 15.33a2.87 2.87 0 0 1 -2.82 2.57h-16l-.08 45.45a2.05 2.05 0 0 1 -2 2.07h-16.21a2 2 0 0 1 -2-2.08v-45.44h-12a2.87 2.87 0 0 1 -2.84-2.9l-.06-15.33a2.88 2.88 0 0 1 2.84-2.92h12.06v-14.8c0-17.18 10.2-26.53 25.16-26.53h12.26a2.88 2.88 0 0 1 2.85 2.92v12.9a2.88 2.88 0 0 1 -2.85 2.92h-7.52c-8.13 0-9.71 4-9.71 9.78v12.81h17.87a2.88 2.88 0 0 1 2.82 3.25z" fill="#fff"/>
                    </g></g>
              ...
              <div class="form-row d-flex justify-content-between m-b30">
                ...
                <div class="form-group">
                  <NuxtLink class="text-primary btn-border btn-link" to="/forget-password">Forgot Password</NuxtLink>
                </div>
              </div>
...
onMounted(() => {
  ...
  // Reset in case the loader was hidden on a previous route.
