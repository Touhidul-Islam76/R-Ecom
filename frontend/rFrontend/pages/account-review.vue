...
useHead({
  ...
  link: [
    { rel: 'canonical', href: 'https://fasionable.dexignzone.com/xhtml/account-review.html' },
...
const reviewCards = [
  { image: '/images/team/pic1.jpg', name: 'Michel Poe' },
  { image: '/images/team/pic2.jpg', name: 'Celesto Anderson' },
  { image: '/images/team/pic3.jpg', name: 'Monsur Rahman Lito' },
  { image: '/images/team/pic4.jpg', name: 'Johan Doe' },
  { image: '/images/team/pic5.jpg', name: 'Michel Poe' },
  { image: '/images/team/pic6.jpg', name: 'Celesto Anderson' },
  { image: '/images/team/pic1.jpg', name: 'Monsur Rahman Lito' },
  { image: '/images/team/pic2.jpg', name: 'Johan Doe' },
]
</script>
            ...
            <div class="dz-bnr-inr-entry">
              <nav aria-label="breadcrumb" class="breadcrumb-row">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Account Review</li>
                </ul>
              </nav>
            </div>
          </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <section class="col-xl-9 account-wrapper">
                <div class="row">
                  <div v-for="(review, index) in reviewCards" :key="`review-${index}`" class="col-md-6 m-b30">
                      ...
                      <div class="review-head">
                        ...
                        <div class="clearfix">
                          ...
                          <div class="star-rating">
                            <i v-for="n in 5" :key="`star-${index}-${n}`" class="fa fa-star text-yellow"></i>
                          </div>
                        </div>
                      </div>
