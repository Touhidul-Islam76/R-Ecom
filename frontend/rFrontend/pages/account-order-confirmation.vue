...
useHead({
  ...
  link: [
    { rel: 'canonical', href: 'https://fasionable.dexignzone.com/xhtml/account-order-confirmation.html' },
            ...
            <div class="dz-bnr-inr-entry">
              <nav aria-label="breadcrumb" class="breadcrumb-row">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Account Order Confirmation</li>
                </ul>
              </nav>
            </div>
          </div>
                ...
                <div class="confirmation-card account-card">
                  ...
                  <div class="text-center mt-4">
                    ...
                    <div class="mt-4 d-sm-flex gap-3 justify-content-center">
                      <a href="/account-order-details" class="btn my-1 btn-secondary">View Order </a>
                      <a href="/" class="btn btn-outline-secondary my-1 btnhover20">Back To Home </a>
                    </div>
                  </div>
                </div>
              </section>
