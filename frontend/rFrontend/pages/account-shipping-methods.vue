...
useHead({
  ...
  link: [
    { rel: 'canonical', href: 'https://fasionable.dexignzone.com/xhtml/account-shipping-methods.html' },
            ...
            <div class="dz-bnr-inr-entry">
              <nav aria-label="breadcrumb" class="breadcrumb-row">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Account Shipping Methods</li>
                </ul>
              </nav>
            </div>
          </div>
              ...
              <section class="col-xl-9 account-wrapper">
                <div class="account-card">
                  <form class="row g-3" @submit.prevent>
                    ...
                    <div class="col-lg-6">
                      <div class="custom-control style-1 style-thumb mb-0">
                        ...
                        <label class="custom-checkbox form-check-label" for="Methods1">
                          <img class="thumb" src="/images/shop/payment/fedex.svg" alt="/" />
                          <span>
                    ...
                    <div class="col-lg-6">
                      <div class="custom-control style-1 style-thumb mb-0">
                        ...
                        <label class="custom-checkbox form-check-label" for="Methods2">
                          <img class="thumb" src="/images/shop/payment/american.svg" alt="/" />
                          <span>
                    ...
                    <div class="col-lg-6">
                      <div class="custom-control style-1 style-thumb mb-0">
                        ...
                        <label class="custom-checkbox form-check-label" for="Methods3">
                          <img class="thumb" src="/images/shop/payment/dhl.svg" alt="/" />
                          <span>
                    ...
                    <div class="col-lg-6">
                      <div class="custom-control style-1 style-thumb mb-0">
                        ...
                        <label class="custom-checkbox form-check-label" for="Methods4">
                          <img class="thumb" src="/images/shop/payment/retrieve.svg" alt="/" />
                          <span>
                            <span class="title">DHL Express</span>
                            <span class="text">Delivery, Today</span>
                          </span>
                    ...
                    <div class="col-12">
                      <a href="/account-payment-methods" class="btn btn-secondary mt-2">Continue to payment</a>
                    </div>
                  </form>
                </div>
              </section>
