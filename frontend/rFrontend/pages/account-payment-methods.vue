...
useHead({
  ...
  link: [
    { rel: 'canonical', href: 'https://fasionable.dexignzone.com/xhtml/account-payment-methods.html' },
            ...
            <div class="dz-bnr-inr-entry">
              <nav aria-label="breadcrumb" class="breadcrumb-row">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Account Payment Methods</li>
                </ul>
              </nav>
            </div>
          </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group m-b25">
                          ...
                          <input type="number" name="dzNumber" required class="form-control" placeholder="1234 4567 8910 1112" />
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group m-b25">
                      ...
                      <div class="col-md-3">
                        <div class="form-group m-b25">
                          ...
                          <input type="number" required class="form-control" placeholder="1234" />
                        </div>
                      </div>
                    </div>
                    <a href="/account-order-confirmation" class="btn btn-secondary mt-2">Confirm Order</a>
                  </form>
                </div>
              </section>
            </div>
