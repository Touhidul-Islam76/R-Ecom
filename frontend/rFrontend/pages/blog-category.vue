...
useHead({
  ...
  link: [
    { rel: 'canonical', href: 'https://plantzone.dexignzone.com/xhtml/blog-category.html' },
                  ...
                  <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="search-info m-b50">
                      <div class="title m-b10">
                        <p class="search-name">Category:</p><h2 class="search-result">Plant</h2>
                      </div>
                  ...
                  <div class="col-lg-12 col-md-6 col-sm-6 m-lg-b30 m-b50 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="dz-card blog-half style-5">
                      ...
                      <div class="dz-info">
                        ...
                        <h2 class="dz-title">
                          <a href="/post-header-image">Essential Plant Care Tips for Beginners</a>
                        </h2>
                  ...
                  <div class="col-lg-12 col-md-6 col-sm-6 m-lg-b30 m-b50 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="dz-card blog-half style-5">
                      ...
                      <div class="dz-info">
                        ...
                        <h2 class="dz-title">
                          <a href="/post-header-image">Nurturing Your Plants with Expert Care</a>
                        </h2>
                        <a href="/post-header-image" class="font-14 read-btn">Read More
                          <i class="icon feather icon-chevron-right"></i>
                        </a>
                  ...
                  <div class="col-lg-12 col-md-6 col-sm-6 m-lg-b30 m-b50 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="dz-card blog-half style-5">
                      ...
                      <div class="dz-info">
                        ...
                        <h2 class="dz-title">
                          <a href="/post-header-image">the Basics for Healthy and Happy Plants</a>
                        </h2>
                        <a href="/post-header-image" class="font-14 read-btn">Read More
                          <i class="icon feather icon-chevron-right"></i>
                        </a>
                  ...
                  <div class="col-lg-12 col-md-6 col-sm-6 m-lg-b30 m-b50 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="dz-card blog-half style-5">
                      ...
                      <div class="dz-info">
                        ...
                        <h2 class="dz-title">
                          <a href="/post-header-image">The Zen of Plant Care through Gardening</a>
                        </h2>
                        <a href="/post-header-image" class="font-14 read-btn">Read More
                          <i class="icon feather icon-chevron-right"></i>
                        </a>
                  ...
                  <div class="col-lg-12 col-md-6 col-sm-6 m-lg-b30 m-b50 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="dz-card blog-half style-5">
                      ...
                      <div class="dz-info">
                        ...
                        <h2 class="dz-title">
                          <a href="/post-header-image">Plant Care Practices for Eco-Conscious</a>
                        </h2>
                        <a href="/post-header-image" class="font-14 read-btn">Read More
                          <i class="icon feather icon-chevron-right"></i>
                        </a>
