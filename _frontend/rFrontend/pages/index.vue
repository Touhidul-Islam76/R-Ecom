          ...
          <div class="row justify-content-center">
            <div class="col-xl-3 col-lg-7 col-md-7 align-self-start order-md-0 order-1">
              ...
              <div class="bottom-contant">
                <div class="Plant-2"><div class="dz-media"><img src="/images/shop/product/4.png" alt="image" loading="lazy" decoding="async"></div></div>
                <div class="Plant-2"><div class="dz-media"><img src="/images/shop/product/3.png" alt="image" loading="lazy" decoding="async"></div></div>
              </div>
            </div>
            ...
            <div class="col-xl-6 col-md-8 col-sm-12 order-3 order-xl-2">
              <div class="tab-content single-product-media">
                <div class="tab-pane fade show active" id="banner-Plant_1-pane" role="tabpanel" aria-labelledby="banner-Plant_1" tabindex="0">
                  <div class="dz-media"><img src="/images/shop/product1.png" alt="/" fetchpriority="high" decoding="async"></div>
                ...
                <div class="tab-pane fade show" id="banner-Plant_2-pane" role="tabpanel" aria-labelledby="banner-Plant_2" tabindex="0">
                  <div class="dz-media"><img src="/images/shop/product2.png" alt="/" loading="lazy" decoding="async"></div>
                  <ul class="list-check style-1">
                    <li class="list-1">Connection to Nature</li>
                    <li class="list-2 right">Temperature Regulation</li>
                    <li class="list-3">Improved Air Quality</li>
                ...
                <div class="tab-pane fade show" id="banner-Plant_3-pane" role="tabpanel" aria-labelledby="banner-Plant_3" tabindex="0">
                  <div class="dz-media"><img src="/images/shop/product3.png" alt="/" loading="lazy" decoding="async"></div>
                  <ul class="list-check style-1">
                    <li class="list-1">Connection to Nature</li>
                    <li class="list-2 right">Temperature Regulation</li>
                    <li class="list-3">Improved Air Quality</li>
                ...
                <div class="tab-pane fade show" id="banner-Plant_4-pane" role="tabpanel" aria-labelledby="banner-Plant_4" tabindex="0">
                  <div class="dz-media"><img src="/images/shop/product4.png" alt="/" loading="lazy" decoding="async"></div>
                  <ul class="list-check style-1">
                    <li class="list-1">Connection to Nature</li>
                    <li class="list-2 right">Temperature Regulation</li>
                    <li class="list-3">Improved Air Quality</li>
                ...
                <ul class="nav nav-tabs center banner-Plant row justify-content-end border-0" id="myTab-3" role="tablist">
                  <li class="col-xl-5 col-lg-6 col-md-6 col-sm-3 col-6 nav-item" role="presentation">
                    <button class="nav-link active" id="banner-Plant_1" data-bs-toggle="tab" data-bs-target="#banner-Plant_1-pane" type="button" role="tab" aria-selected="true">
                      <span class="Plant-1"><span class="dz-media"><img src="/images/shop/medium/1.png" alt="image" loading="lazy" decoding="async"></span></span>
                    </button>
                  </li>
                  <li class="col-xl-5 col-lg-6 col-md-6 col-sm-3 col-6 nav-item p-t50" role="presentation">
                    <button class="nav-link" id="banner-Plant_2" data-bs-toggle="tab" data-bs-target="#banner-Plant_2-pane" type="button" role="tab" aria-selected="false">
                      <span class="Plant-1"><span class="dz-media"><img src="/images/shop/medium/2.png" alt="image" loading="lazy" decoding="async"></span></span>
                    </button>
                  </li>
                  <li class="col-xl-5 col-lg-6 col-md-6 col-sm-3 col-6 nav-item" role="presentation">
                    <button class="nav-link" id="banner-Plant_3" data-bs-toggle="tab" data-bs-target="#banner-Plant_3-pane" type="button" role="tab" aria-selected="false">
                      <span class="Plant-1"><span class="dz-media"><img src="/images/shop/medium/3.png" alt="image" loading="lazy" decoding="async"></span></span>
                    </button>
                  </li>
                  <li class="col-xl-5 col-lg-6 col-md-6 col-sm-3 col-6 nav-item p-t50" role="presentation">
                    <button class="nav-link" id="banner-Plant_4" data-bs-toggle="tab" data-bs-target="#banner-Plant_4-pane" type="button" role="tab" aria-selected="false">
                      <span class="Plant-1"><span class="dz-media"><img src="/images/shop/medium/4.png" alt="image" loading="lazy" decoding="async"></span></span>
                    </button>
                  </li>
                </ul>
                <div class="bottom-contant">
                  <div class="Plant-2"><div class="dz-media"><img src="/images/shop/product/6.png" alt="image" loading="lazy" decoding="async"></div></div>
                  <div class="Plant-2"><div class="dz-media"><img src="/images/shop/product/1.png" alt="image" loading="lazy" decoding="async"></div></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="content-inner position-relative z-1 overflow-hidden" id="Plant_section">
        ...
        <div class="plant-row">
          <div class="tag-slider style-1 wow fadeInUp" data-wow-delay="0.2s" id="tagSlider">
            <div class="item-wrap">
              <div class="item" v-for="(word, idx) in ['Set','your','environment','Set','your','environment','Set','your','environment']" :key="`set-${idx}`">
          ...
          <div class="tag-slider wow fadeInUp" data-wow-delay="0.4s" id="tagSlider2">
            <div class="item-wrap">
              <div class="item" v-for="(word, idx) in ['plant','be','green','plant','be','green','plant','be','green']" :key="`green-${idx}`">
                <span class="plant-text">{{ word }}</span>
              </div>
            </div>
          </div>
  ...
  <div class="container">
    <div class="row justify-content-between align-items-center">
      ...
      <div class="col-lg-6 col-md-4 col-sm-12 text-md-end m-b30 wow fadeInUp" data-wow-delay="0.2s">
        <a class="btn btn-outline-secondary m-b30" href="/blog/post-standard">View All</a>
      </div>
    </div>
  </div>
