...
useHead({
  ...
  link: [
    { rel: 'canonical', href: 'https://fasionable.dexignzone.com/xhtml/account-refund-requests-confirmed.html' },
            ...
            <div class="row">
              ...
              <section class="col-xl-9 account-wrapper">
                <div class="account-card confirmed-request text-center">
                  ...
                  <a class="btn btn-outline-secondary btn-lg btnhover20 m-t15" href="/account/order-details">Check Status</a>
                </div>
              </section>
            </div>
          </div>
