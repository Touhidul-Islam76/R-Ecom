                      ...
                      <ul>
                        ...
                        <li class="month-deal">
                          <div class="clearfix me-3">
                            ...
                            <p class="mb-0">
                              Yes! Send me exclusive offers, personalised, and unique gift ideas,
                              tips for shopping on PlantZone
                        ...
                        <ul>
                          <li>
                            ...
                            <div class="dz-content">
                              <h6 class="name"><a href="/blog/post-standard">A Journey Through Plant</a></h6>
                          ...
                          <li>
                            ...
                            <div class="dz-content">
                              <h6 class="name"><a href="/blog/post-standard">Into Plant Care Cultivation</a></h6>
                          ...
                          <li>
                            ...
                            <div class="dz-content">
                              <h6 class="name"><a href="/blog/post-standard">The Wonders of Plants</a></h6>
                ...
                <div class="mega-menu">
                  <ul>
                    ...
                    <li>
                      ...
                      <ul>
                        <li><a href="/admin/account-dashboard">Dashboard</a></li>
          ...
          <div class="col-xl-12">
            ...
            <div class="swiper category-swiper2 swiper-visible">
              <div class="swiper-wrapper">
                <div class="swiper-slide" v-for="item in popularProducts" :key="item.title">
                  <div class="shop-card">
                    <div class="dz-media">
          ...
          <div class="dz-tabs">
            <ul class="nav nav-tabs center" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="shopping-cart" data-bs-toggle="tab" data-bs-target="#shopping-cart-pane" type="button" role="tab">
                  Shopping Cart <span class="badge badge-light">5</span>
                </button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="wishlist" data-bs-toggle="tab" data-bs-target="#wishlist-pane" type="button" role="tab">
            ...
            <div class="tab-content pt-4" id="dz-shopcart-sidebar">
              ...
              <div class="tab-pane fade" id="wishlist-pane" role="tabpanel">
                <div class="shop-sidebar-cart">
                  <ul class="sidebar-cart-list">
                    <li v-for="item in wishlistItems" :key="item.title">
                      <div class="cart-widget">
                        <div class="dz-media me-3">
                          <img :src="item.image" alt="" />
                        </div>
          ...
          <div class="contact-box1 deznav-scroll">
            ...
            <div class="dz-social-icon dz-hover-move style-2 mb-5">
              <ul>
                ...
                <li><a href="https://twitter.com/dexignzones"><i class="fa-brands fa-twitter"></i></a></li>
                <li><a href="https://www.linkedin.com/showcase/3686700/admin/"><i class="fa-brands fa-linkedin"></i></a></li>
                <li><a href="https://www.instagram.com/dexignzone/"><i class="fa-brands fa-instagram"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
...
@media (max-width: 991.98px) {
  ...
  .mobile-nav-dropdown .dz-social-icon {
    display: block;
  }
}
